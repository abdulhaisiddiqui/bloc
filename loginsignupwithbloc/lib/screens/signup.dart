...
import 'package:loginsignupwithbloc/screens/login_page.dart';
...
class _SignupState extends State<Signup> {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context) => LoginPage(show: (){})));
            },
            child: Text(
              "Sign IN",
              style: TextStyle(
  ...
  Padding logo() {
    return Padding(
      ...
      child: Image.asset('assets/images/nikee.png'),
    );
  }
}